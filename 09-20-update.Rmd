...
time data to the resolution of the hour. Whereas the New Haven data only goes 
back to 2019, the Hartford data goes back to 2005. This data is superior 
to the previous data in most aspects. 

The general downsides are that the data is not as relevant to us, and that the 
data only goes until 2021. While this is a shortcoming, we argue that it is 
relatively minor. First of all, one doesn't expect housing prices to change
significantly given a single crime, especially if the general rate of crime 
remains constant or relatively linear. Second, the historical weight of crime 
since 2005 is still valuable, as appraisals are generally made on the basis of
historical data. The instantaneous rate of crime is not as likely to be as 
important.
